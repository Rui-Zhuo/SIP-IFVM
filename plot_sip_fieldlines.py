...
Outputs: `fieldlines_time.<t>.idr.<seed_index>.html` and, when enabled,
the matching `.png` screenshot.
...
def add_exported_html_overlays(
    ...
    <div class="sip-generator-label">Generated by: plot_sip_fieldlines.py</div>
    """
...
def plot_magnetic_configuration(
    ...
    plotter.add_text(
        "Generated by: plot_sip_fieldlines.py",
